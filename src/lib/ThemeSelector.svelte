...
<div class="relative">
  <button
    class="px-6 py-1 text-lg bg-neutral-100 shadow dark:shadow-none dark:bg-neutral-700 rounded-md cursor-pointer transition-all duration-75 active:bg-neutral-200 dark:active:bg-neutral-600"
